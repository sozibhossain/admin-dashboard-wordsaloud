  ...
  function submit(event: FormEvent<HTMLFormElement>) {
    ...
    save.mutate({
      ...
      payload: {
        ...
        ...(category ? { order: Number(form.get("order")) } : {}),
      },
    });
  }
